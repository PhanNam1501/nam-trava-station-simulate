...
import { VeTravaState, RewardTokenBalance, rewardTokenInfo, TokenLock } from "../../../State/trava/lending/TravaGovenanceState";
...
export async function updateUserLockBalance(appState1: ApplicationState, _userAddress: EthAddress, force = false) {
  let appState = { ...appState1 };
  try {
