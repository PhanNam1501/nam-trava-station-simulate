...
export { AxiosRequestConfig, Config, ContractNetwork, Contract, Network, Networks, EthAddress, bytes32, bytes, uint256, uint160, uint32, uint128, uint80, uint64, uint24, uint16, uint8, int256, int24, wallet_mode, armoury_version, knight_version, BigNumberish };
