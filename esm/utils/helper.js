...
export function isNonUpdateTokenBalance(appState, _userAddress, _tokenAddress) {
...
export function isUserAddress(appState, userAddress) {
...
export const convertApyToApr = (apy) => {
    const n = 365;
    // Calculate (1 + x)
