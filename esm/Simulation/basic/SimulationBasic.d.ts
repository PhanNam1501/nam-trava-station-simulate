...
export declare function simulateSendToken(appState1: ApplicationState, tokenAddress: EthAddress, to: EthAddress, amount: number | string): Promise<ApplicationState>;
