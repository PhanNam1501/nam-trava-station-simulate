...
export declare function simulateSendToken(appState1: ApplicationState, _tokenAddress: EthAddress, to: EthAddress, _amount: number | string): Promise<ApplicationState>;
