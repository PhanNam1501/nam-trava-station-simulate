...
function updateUserTokenBalance(appState1, _address) {
    return __awaiter(this, void 0, void 0, function* () {
        const appState = Object.assign({}, appState1);
        const address = (0, address_1.convertHexStringToAddress)(_address);
...
function updateSmartWalletTokenBalance(appState1, _address) {
    return __awaiter(this, void 0, void 0, function* () {
        const appState = Object.assign({}, appState1);
        const address = (0, address_1.convertHexStringToAddress)(_address);
        const TokenContract = new ethers_1.Contract(address, ERC20Mock_json_1.default, appState.web3);
