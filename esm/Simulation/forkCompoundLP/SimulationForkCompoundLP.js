...
export function calculateMaxAmountForkCompoundSupply(appState, _entity_id, _tokenAddress, _from) {
...
export function calculateMaxAmountForkCompoundWithdraw(appState, _entity_id, _tokenAddress, _from) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        const tokenAddress = _tokenAddress.toLowerCase();
        const mode = getMode(appState, _from);
...
export function calculateMaxAmountForkCompoundRepay(appState, _entity_id, _tokenAddress, _from) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        const tokenAddress = _tokenAddress.toLowerCase();
        const mode = getMode(appState, _from);
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (amount.toFixed() == MAX_UINT256 || amount.isEqualTo(MAX_UINT256)) {
                amount = yield calculateMaxAmountForkCompoundSupply(appState, _entity_id, tokenAddress, _from);
            }
            ...
            const cTokenAmount = BigNumber(appState[modeFrom].tokenBalances.get(cTokenAddress));
...
export function SimulationWithdrawForkCompoundLP(appState1, _from, _entity_id, _tokenAddress, _amount) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let amount = BigNumber(_amount);
            let appState = Object.assign({}, appState1);
            ...
            let modeFrom = getMode(appState, _from);
            if (amount.toFixed() == MAX_UINT256 || amount.isEqualTo(MAX_UINT256)) {
                amount = yield calculateMaxAmountForkCompoundWithdraw(appState, _entity_id, tokenAddress, _from);
            }
            if (!appState[modeFrom].tokenBalances.has(tokenAddress)) {
                appState = yield updateUserTokenBalance(appState, tokenAddress);
            }
...
export function SimulationBorrowForkCompoundLP(appState1, _from, _entity_id, _tokenAddress, _amount) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let amount = BigNumber(_amount);
            let appState = Object.assign({}, appState1);
            ...
            let modeFrom = getMode(appState, _from);
            if (amount.toFixed() == MAX_UINT256 || amount.isEqualTo(MAX_UINT256)) {
                amount = yield calculateMaxAmountForkCompoundBorrow(appState, _entity_id, tokenAddress, _from);
            }
            if (!appState[modeFrom].tokenBalances.has(tokenAddress)) {
                appState = yield updateUserTokenBalance(appState, tokenAddress);
            }
...
export function SimulationRepayForkCompoundLP(appState1, _from, _entity_id, _tokenAddress, _amount) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const tokenAddress = _tokenAddress.toLowerCase();
            if (amount.toFixed() == MAX_UINT256 || amount.isEqualTo(MAX_UINT256)) {
                amount = yield calculateMaxAmountForkCompoundRepay(appState, _entity_id, tokenAddress, _from);
            }
            let modeFrom = getMode(appState, _from);
            if (!appState[modeFrom].tokenBalances.has(tokenAddress)) {
                appState = yield updateUserTokenBalance(appState, tokenAddress);
