...
function updateTokenDetailInOthersPoolsCompound(appState1, _from, entity_id) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            let [cTokenBalance, cTokenDecimal, cTokenTotalSupply, originIncTokenBalance] = yield Promise.all([
            ...
            if (haveBNB) {
                const balance = String(yield ((_a = appState.web3) === null || _a === void 0 ? void 0 : _a.getBalance(token[zeroAddress]["cToken"].toString())));
