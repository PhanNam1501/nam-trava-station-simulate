...
function updateExpeditionState(appState1, force = false) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const expeditions = yield (0, helper_1.multiCall)(NFTExpeditionABI_json_1.default, datas, appState.web3, appState.chainId);
            let listRaritys = [];
            let listTotal = [];
            ...
            for (let i = 0; i < listexpedition.length; i++) {
                ...
                let expedition = Object.assign(Object.assign({}, listexpedition[i]), { totalKnight: total, raritys: raritys, profession: profession, expeditionPrice: expeditionPrice, successPayout: successPayout, successReward: hugeSuccessPayout, token: {
