...
function updateOwnerKnightInExpeditionState(appState1_1, _from_1) {
    return __awaiter(this, arguments, void 0, function* (appState1, _from, force = false) {
...
function updateExpeditionState(appState1_1) {
