...
export declare function calculateMaxAmountTransferTToken(appState: ApplicationState, _tokenAddress: string, _from: EthAddress): BigNumber;
...
export declare function SimulationTransferTToken(appState1: ApplicationState, _from: EthAddress, _to: EthAddress, _tokenAddress: EthAddress, _amount: string): Promise<ApplicationState>;
