...
function updateTravaGovernanceState(appState1_1) {
    return __awaiter(this, arguments, void 0, function* (appState1, force = false) {
...
function updateUserLockBalance(appState1_1, _userAddress_1) {
    return __awaiter(this, arguments, void 0, function* (appState1, _userAddress, force = false) {
        let appState = Object.assign({}, appState1);
        try {
